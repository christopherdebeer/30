...
},{"sassify":12}],3:[function(require,module,exports){
var css = '.frame {\
  font-weight: bold;\
  position: relative;\
  height: 0%;\
...
var css = '.splash {\
  ...
  .splash .logo {\
    ...
    .splash .logo img {\
      margin: 0.5em 0; }\
';(require('sassify'))(css); module.exports = css;
},{"sassify":12}],5:[function(require,module,exports){
var css = 'html, body {\
  margin: 0;\
  padding: 0;\
  font-size: 10px;\
...
.menu {\
  ...
  -webkit-box-shadow: inset -8px 0px 24px -6px black;\
  -moz-box-shadow: inset -8px 0px 24px -6px black;\
  box-shadow: inset -8px 0px 24px -6px black;\
  color: #aaa;\
...
},{"cssify":13}],13:[function(require,module,exports){
module.exports = function (css) {
  var head = document.getElementsByTagName('head')[0],
      style = document.createElement('style');
...
module.exports = AlertView = (function(_super) {
  ...
  AlertView.prototype.template = "<div class=\"inner\">\n<% _(messages).each( function(msg) { %>\n	<p><%= msg %></p>\n<% }); %>\n</div>";

  AlertView.prototype.events = {
    'click': 'handleClick'
  };

  AlertView.prototype.handleClick = function() {
    return this.remove();
  };
...
},{"../assets/css/alert.scss":2,"./BaseView.coffee":16}],16:[function(require,module,exports){
var Backbone, View, _,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"backbone":8,"underscore":14}],17:[function(require,module,exports){
var FrameView, View, moment, _,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = FrameView = (function(_super) {
  ...
  FrameView.prototype.initialize = function(_arg) {
    this.user = _arg.user;
    return console.log("frame init with user: ", this.user);
  };
  ...
  FrameView.prototype.outputMessage = function() {
    ...
    breaks = _.reduce(message, (function(memo, item) {
  ...
  FrameView.prototype.toggleSlide = function(ev) {
    ev.preventDefault();
    if (this.$el.hasClass('slide')) {
      this.$el.removeClass('slide').css({
        transition: 'margin 0.5s',
        marginLeft: '0px',
        marginRight: '0px'
      });
    } else {
      this.$el.addClass('slide').css({
        transition: 'margin 0.5s',
        marginLeft: '150px',
        marginRight: '-150px'
      });
...
module.exports = SplashView = (function(_super) {
  ...
  function SplashView() {
    ...
    this.render = __bind(this.render, this);
    return SplashView.__super__.constructor.apply(this, arguments);
  }

  SplashView.prototype.className = 'splash';

  SplashView.prototype.template = "<div class=\"logo\">\n	<div class=\"triangle\">&#9651;</div>\n	<h1>84</h1>\n</div>";

  SplashView.prototype.number = 1984;

  SplashView.prototype.render = function() {
    SplashView.__super__.render.apply(this, arguments);
    return this.timer = setTimeout(this.tick, 2000);
  };

  SplashView.prototype.tick = function() {
    this.$('h1').html(this.number.toString().slice(2));
    this.number++;
    if (this.number > 2014) {
      return this.timer = setTimeout(this.done, 1000);
    } else {
      return this.timer = setTimeout(this.tick, 50);
    }
  };

  SplashView.prototype.done = function() {
    this.trigger('done');
...
},{"../assets/css/splash.scss":4,"./BaseView.coffee":16}]},{},[1])